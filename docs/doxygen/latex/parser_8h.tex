...
\DoxyCodeLine{                     \textcolor{stringliteral}{"[ \(\backslash\)t\(\backslash\)r\(\backslash\)n\(\backslash\)f]*\(\backslash\)\(\backslash\))[ \(\backslash\)t\(\backslash\)r\(\backslash\)n\(\backslash\)f]*;)?[ \(\backslash\)t\(\backslash\)r\(\backslash\)n\(\backslash\)f]*port"}\(\backslash\)}
\DoxyCodeLine{                     \textcolor{stringliteral}{"[ \(\backslash\)t\(\backslash\)r\(\backslash\)n\(\backslash\)f]*\(\backslash\)\(\backslash\)([ \(\backslash\)t\(\backslash\)r\(\backslash\)n\(\backslash\)f]*(.+\(\backslash\)\(\backslash\))?)[ \(\backslash\)t\(\backslash\)r\(\backslash\)n\(\backslash\)f]*\(\backslash\)\(\backslash\))"}\(\backslash\)}
\DoxyCodeLine{                     \textcolor{stringliteral}{"[ \(\backslash\)t\(\backslash\)r\(\backslash\)n\(\backslash\)f]*;[ \(\backslash\)t\(\backslash\)r\(\backslash\)n\(\backslash\)f]*end[ \(\backslash\)t]*"}\(\backslash\)}
\DoxyCodeLine{                     \textcolor{stringliteral}{"(entity|[a-zA-Z0-9\_]+)?[ \(\backslash\)t]*;[ \(\backslash\)t\(\backslash\)r\(\backslash\)n\(\backslash\)f]*architecture"}}
