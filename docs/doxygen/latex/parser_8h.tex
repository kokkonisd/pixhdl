\hypertarget{parser_8h}{}\doxysection{src/pixhdl/parser.h File Reference}
...
\item 
\#define \mbox{\hyperlink{parser_8h_a109435a96cfe368781e814630b69acdd}{E\+N\+T\+I\+T\+Y\+\_\+\+R\+E\+G\+EX}}
\item 
\#define \mbox{\hyperlink{parser_8h_a2ba0f87dd973431ddf3d8f433052ea3e}{P\+O\+R\+T\+\_\+\+R\+E\+G\+EX}}
\item 
\#define \mbox{\hyperlink{parser_8h_ae374e665c91bc99304282b2660211957}{V\+E\+C\+T\+O\+R\+\_\+\+L\+E\+N\+G\+T\+H\+\_\+\+R\+E\+G\+EX}}
...
\mbox{\hyperlink{struct_entity}{Entity}} $\ast$ \mbox{\hyperlink{parser_8h_a98eda7237f2a4f8679239f8802d55e1d}{get\+Entity\+From\+Raw\+Entity\+Text}} (const char $\ast$entity\+\_\+text, const char $\ast$clock\+\_\+name)
\item 
\mbox{\hyperlink{struct_entity}{Entity}} $\ast$ \mbox{\hyperlink{parser_8h_a172a256a7b9fbe73b4df4c144298b026}{get\+Entity\+From\+File}} (const char $\ast$filename, const char $\ast$clock\+\_\+name)
\end{DoxyCompactItemize}
...
\doxysubsubsection{\texorpdfstring{ENTITY\_REGEX}{ENTITY\_REGEX}}
{\footnotesize\ttfamily \#define E\+N\+T\+I\+T\+Y\+\_\+\+R\+E\+G\+EX}

{\bfseries Value\+:}
\begin{DoxyCode}{0}
\DoxyCodeLine{                     \textcolor{stringliteral}{"entity[ \(\backslash\)t\(\backslash\)r\(\backslash\)n\(\backslash\)f]+([a-\/zA-\/Z0-\/9\_]+)[ \(\backslash\)t\(\backslash\)r\(\backslash\)n\(\backslash\)f]+is"}\(\backslash\)}
\DoxyCodeLine{                     \textcolor{stringliteral}{"[ \(\backslash\)t\(\backslash\)r\(\backslash\)n\(\backslash\)f]+(generic[ \(\backslash\)t\(\backslash\)r\(\backslash\)n\(\backslash\)f]*\(\backslash\)\(\backslash\)([ \(\backslash\)t\(\backslash\)r\(\backslash\)n\(\backslash\)f]*"}\(\backslash\)}
\DoxyCodeLine{                     \textcolor{stringliteral}{"([ \(\backslash\)t\(\backslash\)r\(\backslash\)n\(\backslash\)fa-\/zA-\/Z0-\/9,:.;\_()=*\(\backslash\)\(\backslash\)/-\/]*)\(\backslash\)\(\backslash\))[ \(\backslash\)t\(\backslash\)r\(\backslash\)n\(\backslash\)f]*;)?"}\(\backslash\)}
\DoxyCodeLine{                     \textcolor{stringliteral}{"[ \(\backslash\)t\(\backslash\)r\(\backslash\)n\(\backslash\)f]*port[ \(\backslash\)t\(\backslash\)r\(\backslash\)n\(\backslash\)f]*\(\backslash\)\(\backslash\)([ \(\backslash\)t\(\backslash\)r\(\backslash\)n\(\backslash\)f]*[ \(\backslash\)t\(\backslash\)r\(\backslash\)n\(\backslash\)f]*"}\(\backslash\)}
\DoxyCodeLine{                     \textcolor{stringliteral}{"([ \(\backslash\)t\(\backslash\)r\(\backslash\)n\(\backslash\)fa-\/zA-\/Z0-\/9,:.;\_()=*\(\backslash\)\(\backslash\)/-\/]*)\(\backslash\)\(\backslash\))[ \(\backslash\)t\(\backslash\)r\(\backslash\)n\(\backslash\)f]*;"}\(\backslash\)}
\DoxyCodeLine{                     \textcolor{stringliteral}{"[ \(\backslash\)t\(\backslash\)r\(\backslash\)n\(\backslash\)f]*end[ \(\backslash\)t\(\backslash\)r\(\backslash\)n\(\backslash\)f]*(entity|[a-\/zA-\/Z0-\/9\_]+)?"}\(\backslash\)}
\DoxyCodeLine{                     \textcolor{stringliteral}{"[ \(\backslash\)t\(\backslash\)r\(\backslash\)n\(\backslash\)f]*;"}}
...
\doxysubsubsection{\texorpdfstring{PORT\_REGEX}{PORT\_REGEX}}
{\footnotesize\ttfamily \#define P\+O\+R\+T\+\_\+\+R\+E\+G\+EX}

{\bfseries Value\+:}
\begin{DoxyCode}{0}
\DoxyCodeLine{                   \textcolor{stringliteral}{"([a-\/zA-\/Z0-\/9\_, ]+)[ \(\backslash\)t\(\backslash\)r\(\backslash\)n\(\backslash\)f]*:[ \(\backslash\)t\(\backslash\)r\(\backslash\)n\(\backslash\)f]*((in|out|inout)"}\(\backslash\)}
\DoxyCodeLine{                   \textcolor{stringliteral}{"[ \(\backslash\)t\(\backslash\)r\(\backslash\)n\(\backslash\)f]*(std\_logic[\string^;]*)|([a-\/zA-\/Z0-\/9\_,. \(\backslash\)t-\/]*));"}}
...
\doxysubsubsection{\texorpdfstring{VECTOR\_LENGTH\_REGEX}{VECTOR\_LENGTH\_REGEX}}
{\footnotesize\ttfamily \#define V\+E\+C\+T\+O\+R\+\_\+\+L\+E\+N\+G\+T\+H\+\_\+\+R\+E\+G\+EX}

{\bfseries Value\+:}
\begin{DoxyCode}{0}
\DoxyCodeLine{                            \textcolor{stringliteral}{"(\(\backslash\)\(\backslash\)(([a-\/zA-\/Z0-\/9\_ -\/]+)[ \(\backslash\)t\(\backslash\)r\(\backslash\)n\(\backslash\)f]+(down)?to"}\(\backslash\)}
\DoxyCodeLine{                            \textcolor{stringliteral}{"[ \(\backslash\)t\(\backslash\)r\(\backslash\)n\(\backslash\)f]+([a-\/zA-\/Z0-\/9\_ -\/]+)\(\backslash\)\(\backslash\)))"}}
...
\doxysubsubsection{\texorpdfstring{containsAlpha()}{containsAlpha()}}
...
\end{DoxyReturn}
\mbox{\Hypertarget{parser_8h_a172a256a7b9fbe73b4df4c144298b026}\label{parser_8h_a172a256a7b9fbe73b4df4c144298b026}} 
\index{parser.h@{parser.h}!getEntityFromFile@{getEntityFromFile}}
\index{getEntityFromFile@{getEntityFromFile}!parser.h@{parser.h}}
\doxysubsubsection{\texorpdfstring{getEntityFromFile()}{getEntityFromFile()}}
{\footnotesize\ttfamily \mbox{\hyperlink{struct_entity}{Entity}}$\ast$ get\+Entity\+From\+File (\begin{DoxyParamCaption}\item[{const char $\ast$}]{filename,  }\item[{const char $\ast$}]{clock\+\_\+name }\end{DoxyParamCaption})}
...
\hline
{\em clock\+\_\+name} & ({\ttfamily const char $\ast$})\+: The clock signal\textquotesingle{}s name, as specified by the user. \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
({\ttfamily \mbox{\hyperlink{struct_entity}{Entity}} $\ast$})\+: The \mbox{\hyperlink{struct_entity}{Entity}} object. 
\end{DoxyReturn}
\mbox{\Hypertarget{parser_8h_a98eda7237f2a4f8679239f8802d55e1d}\label{parser_8h_a98eda7237f2a4f8679239f8802d55e1d}} 
...
\doxysubsubsection{\texorpdfstring{getEntityFromRawEntityText()}{getEntityFromRawEntityText()}}
{\footnotesize\ttfamily \mbox{\hyperlink{struct_entity}{Entity}}$\ast$ get\+Entity\+From\+Raw\+Entity\+Text (\begin{DoxyParamCaption}\item[{const char $\ast$}]{entity\+\_\+text,  }\item[{const char $\ast$}]{clock\+\_\+name }\end{DoxyParamCaption})}
...
\doxysubsubsection{\texorpdfstring{getRawEntityTextFromFile()}{getRawEntityTextFromFile()}}
...
{\ttfamily Entity\+Name;} {\ttfamily $\ast$\+Generic1\+:value;Generic2\+:value;...;} {\ttfamily @Port1\+:value;Port2\+:value;...;}
...
\doxysubsubsection{\texorpdfstring{isLegalPortNameChar()}{isLegalPortNameChar()}}
...
\doxysubsubsection{\texorpdfstring{parseSignalDirection()}{parseSignalDirection()}}
...
\doxysubsubsection{\texorpdfstring{parseSignalLength()}{parseSignalLength()}}
...
\doxysubsubsection{\texorpdfstring{parseSignalName()}{parseSignalName()}}
