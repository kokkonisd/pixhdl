...
void printEntitySignals (Entity * ent)
{
    // For-loop counter
    unsigned int i = 0;
    // Counter for the amount of spaces a signal name can occupy
    unsigned int name_spaces = ent->max_name_size_global > 4 ?
                               ent->max_name_size_global : 4;
    // Counter for the amount of spaces a signal length/value can occupy
    unsigned int length_spaces = ent->max_length_size_global > 32 ?
